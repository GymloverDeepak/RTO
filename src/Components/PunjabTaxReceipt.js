...
import watermarkImage from "../Punjab.png"; // Ensure correct path
import { QRCodeCanvas } from "qrcode.react";

const PunjabTaxReceipt = ({ data }) => {
  const pdfRef = useRef();
  const itemsPerRow = 4;
  const rows = 25;
        ...
        >
          ...
          <tbody>
            <tr>
              ...
              <td style={{ border: "1px solid #3f51b5", padding: 6 }}>00</td>
            ...
            <tr>
              ...
              >
               Civic Infra Cess ({taxStartDate} TO {taxEndDate})
              </td>
            ...
            <tr>
              ...
              >
                 Service/User Charge ({taxStartDate} TO {taxEndDate})
              </td>
...
export default PunjabTaxReceipt;
